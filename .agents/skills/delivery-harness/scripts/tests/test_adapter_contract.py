...
class AdapterContractTests(unittest.TestCase):
    ...
    def test_project_templates_point_at_the_runtime_adapter_reference(self) -> None:
        agents = (SKILLS_ROOT / "delivery-harness" / "assets" / "templates" / "PROJECT_AGENTS.template.md").read_text(encoding="utf-8")
        ...
        for content in (agents, claude):
            ...
            self.assertNotIn("Product Delivery Harness adapter", content)
