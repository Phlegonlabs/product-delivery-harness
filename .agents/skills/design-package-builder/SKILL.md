...
6. Confirm the design-target classification from step 5's `AskUserQuestion` answer: SaaS app, dashboard, internal tool, public website, marketing page, docs/content site, ecommerce/catalog, mobile app, or hybrid. Only infer it instead when the user explicitly authorized assumptions.
