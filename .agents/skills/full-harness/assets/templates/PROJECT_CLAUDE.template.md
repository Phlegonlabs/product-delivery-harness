...
- Use the Full-Stack Harness runtime adapter reference (Claude Code section) for Claude worker roles, model selection, Dynamic Workflow, and Agent Teams behavior. Do not copy Codex or Pi launch mechanics into a Claude worker.
