...
- **0.39.0** — HiFi conectado usa `ui-hifi/2` con hashes de páginas HTML hermanas, destinos de controles y evidencia de clic/teclado `ui-output/2`. La revisión Git congelada incluye todas las páginas. Schema 1 sin cambios sigue siendo legible; HiFi nuevo o revisado usa el contrato nuevo. También corrige la aprobación Toolchain de CLI, colisiones de nombres parity y ACL de ejecutables Windows.
