...
- **Reading the rules is mandatory.** The seeded project `AGENTS.md` requires every session to read the bound `delivery-harness` SKILL.md before managed work and the affected PRD sections before product-affecting direct work; skipping it is a blocking review finding.
