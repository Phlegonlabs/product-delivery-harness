...
7. Repair blocking findings inside the same worktree and review the new head again. Only then may the parent serially integrate the mission into the resolved target-repository integration branch.
