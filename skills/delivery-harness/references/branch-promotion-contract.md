...
The external authorization must name the allowed-signers path/hash, principal, and OS-managed verifier path/hash. The local agent cannot choose a fake verifier or trust policy.
